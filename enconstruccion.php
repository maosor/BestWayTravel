...
<style media="screen">
  ...
  <body class="blue-grey lighten-5">
    <nav class="orange darken-3"style="height: 40px !important;line-height: 40px;">
      <span class="hide-on-small-only">Oficina: (506) 2101-0042 | Celular: (506) 7200-2542</span>
    ...
    <div class="content grey-text darken-4">
      <center>
        <br> <br>
          <img src="admin/img/logo-png.png"  height="25%" width="50%"alt="">
          <br>
          <img src="admin/img/enconstruccion.png" margin= "100px" height="10%" width="10%"alt="">
          <h1 class="header">SITIO WEB EN CONSTRUCCIÓN</h1>
          <h3 class="header">PRONTO ESTAREMOS EN LÍNEA</h3>
        </center>
    </div>
