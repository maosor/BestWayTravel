    ...
    <nav id = "top-bar"class="orange darken-3"style="height: 40px !important;line-height: 40px;">
      <div class="nav-wrapper">
        <ul class="nav-bar">
           ...
           <li class="right"><a href="https://www.facebook.com/BestWayTravelcr" class="right"><img class="orange darken-4 bordeimg circle z-depth-1" src="admin/img/facebook.png" style="padding: 4px;margin: 3px;"> </a>
           <li class="right"><a href="https://api.whatsapp.com/send?phone=50672002542" class="right"><img class="orange darken-4 bordeimg circle z-depth-1" src="admin/img/whatsapp.png" style="padding: 4px;margin: 3px;"> </a>
          <li class="right">
