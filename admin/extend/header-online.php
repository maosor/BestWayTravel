...
<html>
  ...
  <body class="grey lighten-5">
    <nav class="orange darken-3"style="height: 40px !important;line-height: 40px;">
      <span class="hide-on-small-only">Llámenos al (506) 2101-0042 | Asistencia WhatsApp (506) 7200-2542</span>
    ...
    <nav class="grey lighten-5" >
      ...
      <a href="index.php" class="blue-grey-text brand-logo lelf"><img class="grey lighten-5"src="admin/img/logo-png.png" /></a>
        <ul id="nav-mobile" class="right hide-on-med-and-down">
          ...
          <li><a href="index.php" class="orange  center enf">Cotizar</a></li>
          <li> <form>
        <div class="input-field">
          <i class="material-icons prefix blue-grey-text text-darken-2">search</i>
          <input name="search" class="border" type="search" required>
